...
class TestCases(unittest.TestCase):
    ...
    # def test_insertByG(self):
    #     path_1 = self.create_path_with_g([12, 8, 7], 84.52)
    #     path_2 = self.create_path_with_g([12, 8, 13, 9], 235.23)
    #     path_3 = self.create_path_with_g([12, 8, 15, 11], 350.12)
    #     original = [path_1, path_3, path_2]
    #     path_4 = self.create_path_with_g([12, 8, 7], 32.52)
    #     path_5 = self.create_path_with_g([12, 8, 13, 9], 1.23)
    #     path_6 = self.create_path_with_g([12, 8, 15, 11], 270.12)
    #     expanded = [path_4, path_5, path_6]
    #     sortedPath = insert_cost(expanded, original)
    #     for p in sortedPath:
    #         print(p.g)
